...
# Optionally, assign column names to make it clearer
colnames(myData) <- c(
  "returnSP500", "returnAA", "returnAXP", "returnBA", "returnBAC","returnCAT",
  "returnCSCO", "returnCVX", "returnDD", "returnDIS", "returnGE",
  "returnHD", "returnHPQ", "returnIBM", "returnINTC", "returnJNJ",
  "returnJPM", "returnKRFT", "returnKO", "returnMCD", "returnMMM",
  "returnMRK", "returnMSFT", "returnPFE", "returnPG", "returnT",
...
stock_names <- c("returnAA", "returnAXP", "returnBA", "returnBAC", "returnCAT",
                 "returnCSCO", "returnCVX", "returnDD", "returnDIS", "returnGE",
                 "returnHD", "returnHPQ", "returnIBM", "returnINTC", "returnJNJ",
                 "returnJPM", "returnKRFT", "returnKO", "returnMCD", "returnMMM",
                 "returnMRK", "returnMSFT", "returnPFE", "returnPG", "returnT",
...
for (stock in stock_names) {
  ...
  formula <- as.formula(paste(stock, "~ returnSP500"))
...
```{r}
# Convert the named vector beta_values into a data frame
