...
```{r, Decision Tree, echo=FALSE, warning=FALSE}
## grow tree
Stock_tree <- tree(Positive_percent_change_ind ~ ., data = train)
...
```{r, Predicting on Test, echo=FALSE, warning=FALSE}
# Evaluating
...
```{r, Pruning Decision Tree, echo=FALSE, warning=FALSE}
set.seed(11)
...
```{r Regression Decision Tree, echo=FALSE, warning=FALSE}
train2 = dow_data %>% 
...
ADD CAPM SHIT HERE - HOW WE WILL USE IT, WHAT IT TELLS US, ETC


# Lit. Review

*Discusses and cites existing works in the theoretical and application realm.*
Article: http://www.warse.org/IJATCSE/static/pdf/file/ijatcse135952020.pdf 
